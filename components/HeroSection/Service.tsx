...
const Service = () => {
  return (
    <div className='w-full   flex justify-center items-center mt-10 lg:mt-20 my-10 lg:my-20 py-10'>
        <div className='w-[80%] justify-between gap-[40px]  items-center text-white px-10 md:lg:px-20'>
            ...
            <div className='flex flex-col gap-3 items-center justify-center'>
                ...
                <p className='font-bold max-sm:text-[18px] text-[24px] leading-[32px]'>Professional Chefs</p>
                <h1 className='font-bold text-[40px]'>420</h1>

            </div>
            <div className='flex flex-col gap-3 items-center justify-center'>
                <Image src={group3} alt='group'/>
                <p className='font-bold max-sm:text-[18px] text-[24px] leading-[32px]'>Items Of Food</p>
                <h1 className='font-bold text-[40px]'>320</h1>

            </div>
            <div className='flex flex-col gap-3 items-center justify-center'>
                <Image src={group1} alt='group'/>
                <p className='font-bold max-sm:text-[18px] text-[24px] leading-[32px]'>Years Of Experienced</p>
                <h1 className='font-bold text-[40px]'>30+</h1>

            </div>
            <div className='flex flex-col gap-3 items-center justify-center'>
                <Image src={group2} alt='group'/>
                <p className='font-bold max-sm:text-[18px] text-[24px] leading-[32px]'>Happy Customers</p>
