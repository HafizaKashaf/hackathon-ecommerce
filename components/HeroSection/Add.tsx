...
const Add = () => {
  return (
    <div className='w-full  flex justify-center  mt-20  max-sm:pb-12'>
        ...
        <Image src={add} alt='picture' className='max-sm:h-36' />
        <div className=' text-white absolute max-sm:left-10 right-20 flex flex-col max-sm:2 gap-[16px] items-end lg:w-[50%] '>
            <Image src={heading} alt='heading' className='max-sm:w-[100px] w-[248px] max-sm:h-[20px] h-[40px] max-sm:hidden' />
          ...
          <p className='font-normal text-[14px] leading-[21px] lg:text-end max-sm:hidden'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque diam pellentesque bibendum non dui volutpat fringilla bibendum. Urna, elit augue urna, </p>
