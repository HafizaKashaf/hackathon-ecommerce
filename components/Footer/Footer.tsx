            ...
            <div className="w-full flex pr-2   max-sm:gap-3 justify-between max-sm:flex-col max-sm:w-[310px] max-sm:h-[261px] border-b border-[#FF9F0D] pb-5 lg:pb-10">
                  ...
                  <div className=" w-[380px] flex flex-col gap-[16px] max-sm:w-[310px] max-sm:h-[146px]">
                      <div className='flex max-sm:w-[310px] w-[400px]   max-sm:flex-col  max-sm:h-[112px]'>
                         <input className='h-[48px] w-[256px] border-solid border-black border-[1px] rounded-[5px] p-3 placeholder-[#FAFAFA] max-sm:w-[310px] max-sm:h-[48px] bg-[#FF9F0D] outline-none' placeholder='Enter your email' type="text"  />
                         <button className=' text-[16px] leading-[24px] border-solid rounded-[5px] border-black border-[1px] max-sm:w-[310px] max-sm:h-[48px] bg-white text-[#FF9F0D] font-normal px-2'>Subscribe Now</button>
                       </div>
